package Slic3r::GUI::BioPrintingDialog;
use strict;
use warnings;
use utf8;
...
sub new {
    my $class = shift;
    my ($parent) = @_;
    my $self = $class->SUPER::new($parent, -1, 'BioPrinting Instructions', wxDefaultPosition, [600, 440], wxCAPTION);
    ...
    my $text =
        ...
        '<br /><br />' .
        '<font>' .
        'Copyright &copy; 2011-2017 Alessandro Ranellucci. Bernardo S<br />' .
        '<a href="http://slic3r.org/">Slic3r</a> is licensed under the ' .
        '<a href="http://www.gnu.org/licenses/agpl-3.0.html">GNU Affero General Public License, version 3</a>.' .
        '<br /><br /><br />' .
        'Instructions Here.... BioSlicer!!' .
        '</font>' .
        '</body>' .
        '</html>';
